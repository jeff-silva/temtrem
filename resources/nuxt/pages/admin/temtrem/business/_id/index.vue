            ...
            <div class="col-12 col-md-8">
                <el-tabs v-model="tab" type="border-card">
                    ...
                    <el-tab-pane name="groups" label="Grupos" v-if="model.id">
                        ...
                        <div class="input-group mb-2" v-for="g in model.groups">
                            <input type="text" class="form-control" v-model="g.name">
                            
                            <el-select class="form-control" v-model="g.products" multiple filterable placeholder="Select">
                                <el-option
                            ...
                            <div class="input-group-append"><div class="input-group-btn">
                                <button type="button" class="btn btn-danger" @click="businessGroupRemove(g)">
